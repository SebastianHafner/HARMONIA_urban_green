...
def run_training(cfg):
    ...
    dataset = datasets.TrainChangeDataset(cfg, 'train')
    print(dataset)
    ...
    for epoch in range(1, epochs + 1):
        ...
        for i, batch in enumerate(dataloader):
            ...
            x_t1, x_t2 = batch['x_t1'].to(device), batch['x_t2'].to(device)
            ...
            if global_step % cfg.LOG_FREQ == 0 and not cfg.DEBUG:
                ...
                evaluation.model_evaluation_change(net, cfg, device, 'train', epoch_float, max_samples=1_000)
                evaluation.model_evaluation_change(net, cfg, device, 'val', epoch_float)
        ...
        evaluation.model_evaluation_change(net, cfg, device, 'train', epoch_float, global_step)
        evaluation.model_evaluation_change(net, cfg, device, 'val', epoch_float, global_step)
